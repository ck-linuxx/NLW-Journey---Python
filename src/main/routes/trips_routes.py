...
from src.controllers.activities_finder import ActivityFinder

#Repositories
from src.models.repositories.trips_repository import TripsRepository
from src.models.repositories.emails_to_invite_repository import EmailsToEnviteRepository
from src.models.repositories.links_repository import LinksRepository
from src.models.repositories.partipants_repository import ParticipantsRepository
...
def create_trip():
    ...
    emails_repository = EmailsToEnviteRepository(conn)
...
def cofirm_participant(participantsId):
    conn = db_connection_handler.get_connection()
    participants_repository = ParticipantsRepository(conn)
